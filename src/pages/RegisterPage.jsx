          ...
          {success ? (
            <div className="flex flex-col items-center gap-4 py-2">
              ...
              <div className="text-center">
                <h2 className="text-zinc-100 font-semibold mb-1">Cuenta creada</h2>
              ...
              <Link
                to="/login"
                className="mt-2 w-full py-2.5 rounded-lg bg-emerald-500 hover:bg-emerald-400 text-zinc-950 font-semibold text-sm tracking-wide transition-colors text-center"
              >
                Ir al login
              </Link>
            </div>
            ...
            <>
              <h1 className="text-xl font-semibold text-zinc-100 mb-1">Crear cuenta</h1>
              <p className="text-zinc-500 text-sm mb-6">Completa los datos para registrarte.</p>
